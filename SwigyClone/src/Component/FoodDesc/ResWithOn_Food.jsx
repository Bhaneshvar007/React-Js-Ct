            ...
            <div className='flex gap-6 flex-wrap mt-10 mb-10' >
                {
                    recipiesData.map((ele, id) => (
                        <div key={id} className='flex flex-col  lg:w-[275px] w-[300px] shrink-0 duration-500 cursor-pointer lg:ml-0 ml-4'
                            onClick={() => clickHandler(id)}
                            // data-aos="zoom-in-down"
                        >
                            <div className='overlay lg:h-[185px] h-[250px] lg:w-[273px] w-[400px] rounded-xl overflow-hidden relative '>
