...
const BestPlace = () => {
    ...
    return (
        <div className='max-w-[1200px] mx-auto'>
            ...
            <div className='flex justify-center gap-4 gap-y-0 flex-wrap '>
                {
                    LocateData.map((e) => {
                        return (
                            <div className='border border-[#888] lg:w-[280px] w-[350px] py-4 flex items-center justify-center rounded-[6px] mt-5 cursor-pointer mb-3'>
